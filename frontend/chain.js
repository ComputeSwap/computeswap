...
export const ABI = {
  ...
  auction: [
    "function create(uint256 seriesId, uint128 lot, address payToken, uint128 startPrice, uint128 floorPrice, uint64 announcementDuration, uint64 dropDuration) returns (uint256 auctionId)",
    ...
    "function auctions(uint256 auctionId) view returns (address seller, uint64 start, uint64 dropStart, uint64 end, address payToken, uint256 seriesId, uint128 lot, uint128 remaining, uint128 startPrice, uint128 floorPrice)",
    "function nextAuctionId() view returns (uint256)",
    "event AuctionCreated(uint256 indexed auctionId, address indexed seller, uint256 indexed seriesId, uint128 lot, address payToken, uint128 startPrice, uint128 floorPrice, uint64 start, uint64 dropStart, uint64 end)",
